      ...
      >
        <div
          className={cn(
            ...
            timelineMode ? "lg:px-9 lg:py-9 xl:px-10 xl:py-10" : "lg:px-10 lg:py-10",
          )}
        >
        ...
        <div
          className={cn(
            ...
            timelineMode ? "lg:min-h-[28rem] xl:min-h-[30rem]" : "",
          )}
        >
          <Image
            alt={module.title}
            className={cn("object-cover", timelineMode ? timelineImagePosition : "object-right")}
            fill
            priority={false}
