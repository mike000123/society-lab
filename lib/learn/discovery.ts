...
export const LEARNING_PATHS: LearningPathCard[] = [
  ...
  {
    description:
      "Use ecological limits, delayed feedback loops, and city systems to make climate risk concrete instead of abstract.",
    duration: "4-7 hrs",
    featured: true,
    ...
    summary:
      "Build the World3 and planetary-boundaries mindset and explore overshoot, tipping points, and transitions.",
